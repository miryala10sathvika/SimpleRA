...
class BufferManager{
    ...
    void writePage(string tableName, int pageIndex, vector<vector<int>> rows, int rowCount,int type,int switchPageInd, string tableName2,vector<vector<int>> rows2);
    void writePageRow(string tableName, int pageIndex, vector<int> rows, int rowCount,int type,int switchPageInd, string tableName2,vector<vector<int>> rows2);
    void clearSet();
    void clearCSV(string tableName);
